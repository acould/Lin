 ...
 */
@Controller
@RequestMapping("/product/storein")
public class ProductStoreInController extends BasicController {
	...
	public String list(Model model, StoreInVo dataVo) throws BizRuleException {
