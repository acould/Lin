...
<#assign webTitle="仓库管理系统-平台管理-字典表资源管理" in model>
...
<li><a href="/platform/mresource/list.html">字典资源管理</a></li>
				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/platform/mresource/detail.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/platform/mresource/list.html" method="get" class="form_search fr">
							        	 <table>
					                        <tr>
					                            <td>
					                                <label>资源类型：</label>
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/platform/mresource/detail.html?key=${r.key!}&type=${r.type!}">
