...
<#assign webTitle="仓库管理系统-平台管理-资源管理-新增树字典资源" in model>
...
<li><a href="/platform/mresourcetree/list.html">数字典资源管理</a></li>
<li class="active"><#if (objectBean.key)??>修改树字典资源<#else>新增树字典资源</#if></li>
</#assign>
