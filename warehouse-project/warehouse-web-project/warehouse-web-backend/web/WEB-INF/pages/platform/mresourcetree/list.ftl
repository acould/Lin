...
<#assign webTitle="仓库管理系统-平台管理-树字典表资源管理" in model>
...
<li><a href="/platform/mresourcetree/list.html">树字典资源管理</a></li>
				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/platform/mresourcetree/detail.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/platform/mresourcetree/list.html" method="get" class="form_search fr">
							        	 <table>
					                        <tr>
					                            <td>
					                                <label>资源类型：</label>
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/platform/mresourcetree/detail.html?key=${r.key!}&type=${r.type!}">
...
<script src="${model.static_domain}/js/admin/platform/mresourcetree/list.min.js?v=${model.static_version}"></script>
</#assign>
