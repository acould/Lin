...
<#assign webTitle="仓库管理系统-平台管理-资源管理-新增文本资源" in model>
...
<li><a href="/platform/mresourcetext/list.html">资源管理</a></li>
<li class="active"><#if (objectBean.key)??>修改文本资源<#else>新增文本资源</#if></li>
</#assign>
		...
		<#-- PAGE CONTENT BEGINS -->	
			<form class="form-horizontal" role="form">		
				...
				<div class="action pb30">
					<label>&nbsp;</label>
					<#if (objectBean.key)??>
					<a href="javascript:;" class="btn confirm J_ResourceUpdate" data-type="${(objectBean.type)?if_exists}" data-key="${(objectBean.key)?if_exists}">修改文本资源</a>
					<#else>
					<a href="javascript:;" class="btn confirm btn-lg btn-success J_ResourceAdd">新增文本资源</a>
					</#if>
				</div>
