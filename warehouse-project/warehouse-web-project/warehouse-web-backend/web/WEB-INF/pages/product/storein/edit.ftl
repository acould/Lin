...
<#assign webTitle="多智啦仓库管理系统-新增入库单" in model>
...
<li class="active"><#if (dataVo.id)??>修改入库单<#else>新增入库单</#if></li>
</#assign>
...
<script src="${model.static_domain}/js/admin/product/storein/edit.min.js?v=${model.static_version}"></script>
</#assign>
