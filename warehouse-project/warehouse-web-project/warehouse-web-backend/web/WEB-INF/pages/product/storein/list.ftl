...
<li><a href="/product/storein/list.html">入库单管理</a></li>
				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/product/storein/edit.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/product/storein/list.html" method="get" class="form_search">
							        	<label>货币名称：</label>
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/product/storein/edit.html?id=${r.id}">
...
<script src="${model.static_domain}/js/admin/product/storein/list.min.js?v=${model.static_version}"></script>
</#assign>
