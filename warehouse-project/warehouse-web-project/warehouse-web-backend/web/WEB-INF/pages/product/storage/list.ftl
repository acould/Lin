...
<li><a href="/product/storage/list.html">货品存储信息管理</a></li>
				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/product/storage/edit.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/product/storage/list.html" method="get" class="form_search">
							        	<label>货币名称：</label>
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/product/storage/edit.html?id=${r.id}">
...
<script src="${model.static_domain}/js/admin/product/storage/list.min.js?v=${model.static_version}"></script>
</#assign>
