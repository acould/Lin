...
<#assign webTitle="多智啦仓库管理系统-新增货品存储信息" in model>
...
<li class="active"><#if (dataVo.id)??>修改货品存储信息<#else>新增货品存储信息</#if></li>
</#assign>
...
<script src="${model.static_domain}/js/admin/product/storage/edit.min.js?v=${model.static_version}"></script>
</#assign>
