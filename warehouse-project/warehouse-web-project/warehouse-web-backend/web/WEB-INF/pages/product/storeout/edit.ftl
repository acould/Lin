...
<#assign webTitle="多智啦仓库管理系统-新增出库单" in model>
...
<li class="active"><#if (dataVo.id)??>修改出库单<#else>新增出库单</#if></li>
</#assign>
...
<script src="${model.static_domain}/js/admin/product/storeout/edit.min.js?v=${model.static_version}"></script>
</#assign>
