...
<#assign webTitle="多智啦仓库管理系统-新增仓库分类" in model>
...
<li class="active"><#if (dataVo.id)??>修改仓库分类<#else>新增仓库分类</#if></li>
</#assign>
...
<script src="${model.static_domain}/js/admin/warehouse/warehouseclass/edit.min.js?v=${model.static_version}"></script>
</#assign>
