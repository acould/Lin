...
<li><a href="/wechat/appsetting/list.html">公众号管理</a></li>
				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/wechat/appsetting/edit.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/wechat/appsetting/list.html" method="get" class="form_search">
							        	<label>公众号名称：</label>
								        <input type="text" name="gzhName" value="${gzhName!}" placeholder="请输入公众号名称..." class="searchField base-input">
							   ...
							   <#if (bizObj.list?exists && bizObj.list?size>0)>
									<#list bizObj.list as r>
										<tr>
											...
											<td>${r.weixinNo!}</td>
											<td class="hidden-480">${r.gzhTypeName!} </td>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a href="javascript:;" class="blue J_PublishMenu" data-id="${r.id!}">
														<i class="ace-icon fa fa-search-plus bigger-130">发布菜单</i>
													</a>
			
													<a class="green" href="/wechat/appsetting/edit.html?id=${r.id}">
...
<script src="${model.static_domain}/js/admin/platform/wechat/appsetting.min.js?v=${model.static_version}"></script>
</#assign>
