				...
				<div class="col-xs-12">
					...
					<div class="page-header">
						<table style="width:98%;">
							<tr>
								<td><a href="/wechat/msg/edit.html" class="btn btn-primary">添 加</a>
								</td>
								<td style="text-align:right" >
									 <form action="/wechat/msg/list.html" method="get" class="form_search">
							        	<label>消息名称：</label>
				        				<input type="text" name="gzhName" value="${gzhName!}" placeholder="请输入消息名称..." class="searchField base-input">
										...
										<tr>
											...
											<td>
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="green" href="/wechat/msg/edit.html?id=${r.id}">
