 ...
 * @haoxz11MyBatis
 */
public class StorageAreaVo extends BaseVo {
	/**
	 *
	 * @haoxz11MyBatis
	 */
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="库区类型不能为空")
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="存储区名称不能为空")
	private String name;
