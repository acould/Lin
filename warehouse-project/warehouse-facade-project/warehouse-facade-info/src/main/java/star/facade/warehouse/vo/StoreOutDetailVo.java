 ...
 * @haoxz11MyBatis
 */
public class StoreOutDetailVo extends BaseVo {
	/**
	 *
	 * @haoxz11MyBatis
	 */
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="仓库不能为空")
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="出库单不能为空")
