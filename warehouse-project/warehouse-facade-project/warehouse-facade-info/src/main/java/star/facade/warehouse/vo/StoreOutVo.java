 ...
 * @haoxz11MyBatis
 */
public class StoreOutVo extends BaseVo {
	/**
	 *
	 * @haoxz11MyBatis
	 */
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="审核状态不能为空")
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="出库单号不能为空")
	private String code;
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="外部单号类型不能为空")
	 ...
	 * @haoxz11MyBatis
	 */
	@ValidationParam(type=ValidationType.NotBlank,msg="外部单号不能为空")
	private Long outId;
