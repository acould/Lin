...
import windowUtil from '../../main/ipcRenderer'
...
import accountManagement from '@/pages/login/accountManagement' // 账号注册 忘记密码
import companyInfo from '@/pages/login/companyInfo' // 填写公司信息
// import login from '@/pages/login/webLogin' // 登录
...
router.beforeEach((to, from, next) => {
  ...
  const isInit = remote.getGlobal('sharedObject').isInit
  if (isInit) {
    let hasToken
    if (token) {
      hasToken = true
    ...
    windowUtil.validToken(hasToken)
  }
