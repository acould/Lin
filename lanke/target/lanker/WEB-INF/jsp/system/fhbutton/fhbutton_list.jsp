							...
							<tr>
								...
								<td style="vertical-align:top;padding-left:14px">
									<a class="btn btn-success btn-sm" onclick="tosearch();"  title="检索">
										...
										<i class="layui-icon" id="nav-search-icon" style="padding-right: 4px">&#xe615;</i>搜索
									</a>
								</td>
								</c:if>
							</tr>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-sm btn-success" title="编辑" onclick="edit('${var.FHBUTTON_ID}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-sm btn-danger" onclick="del('${var.FHBUTTON_ID}');">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									...
									<c:if test="${QX.del == 1 }">
									<a class="btn btn-xs btn-danger" onclick="makeAll('确定要删除选中的数据吗?');" title="批量删除" ><i class='ace-icon fa fa-trash-o bigger-120'></i></a>
									</c:if>
								</td>
