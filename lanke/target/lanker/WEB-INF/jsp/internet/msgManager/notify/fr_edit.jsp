...
<form class="layui-form" action="" style="padding:20px 30px" lay-filter="form" id="form">
    ...
    <input type="hidden" value="failure_recovery" id="temp_type" name="temp_type">
    ...
    <div class="layui-form-item" id="store_box">
        <label class="layui-form-label">恢复门店：</label>
        <div class="layui-input-block">
            <span class="layui-btn layui-btn-sm layui-btn-primary" onclick="chooseStore_v()"><i class="layui-icon">&#xe654;</i>选择门店</span>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="first_data" id="first_data" autocomplete="off" lay-verify="required"
                   placeholder="请输入标题" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">恢复内容：</label>
        <div class="layui-input-block">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="recover_time"  id="recover_time" lay-verify="required" placeholder="请选择恢复时间"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="is_has_url" value="false" title="否" lay-filter="is_has_url">
        </div>
    </div>
    ...
    layui.use(["form","layer","laydate"],function (){
        ...
        form.verify({
            hasChoose: function (value, item) { //value：表单的值、item：表单的DOM对象
                ...
                if (ue.getContent().trim() == '' && ( $("#hasUrl").is(":checked") )) {
                    return '请输入图文内容';
                }
            },
        })
        ...
        function initialize(){
            ...
            $.post('<%=basePath%>msgManager/loadTempMsg.do', field, function (res){
                ...
                form.val("form",{
                    ...
                    ,"content":keyword_data.keyword1
                    ,"recover_time":keyword_data.keyword2
        ...
        form.on('submit(submit)', function(data){
            ...
            keyword_data.keyword1 = $("#content").val();
            keyword_data.keyword2 = $("#recover_time").val();
            field.keyword_data = JSON.stringify(keyword_data);

            var ue = UE.getEditor("temp_content");
            field.temp_content = ue.getContent();
            field.send_obj = "member";//默认会员
