...
<form action="" id="form">
	...
	<input type="hidden" id="CARDED" name="CARDED" value="${user.CARDED}">
    <div class="weic-bindCard-body">
        ...
        <div class="weic-bindMsg-item">
            <i class="card"></i>
            <input type="text" placeholder="请输入会员卡号" id="sfz" name="sfz" data-isblur="msg.sfz($(this))" data-group-state="false" value="${user.CARDED}">
        </div>

        <div class="weic-bindMsg-item">
            <i class="phone"></i>
            <input type="text" placeholder="请输入手机号" id="phone" name="phone" value="${pdBind.PHONE}" data-isblur="msg.phone($(this))" data-group-state="false" value="${user.PHONE}">
        </div>
        <div class="weic-bindMsg-item">
            <i class="msg"></i>
        ...
        <div class="weic-bindMsg-item">
            <div class="weic-dent-btn weic-btn-gradientBlue" onclick="do_member('<%=basePath%>intenetmumber/Membership1.do')" >确定办理</div>
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    //渲染门店数据
    getStore('<%=basePath%>intenetmumber/memberInternet.do');
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.message == "success"){
                        window.location.href = '<%=basePath%>intenetmumber/succeed?falg='+data.falg;
