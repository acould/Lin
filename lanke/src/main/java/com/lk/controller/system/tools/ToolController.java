package com.lk.controller.system.tools;
...
import com.lk.util.MapDistance;
import com.lk.util.PageData;
import com.lk.util.PathUtil;
import com.lk.util.PublicManagerUtil;
import com.lk.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	public Object severTest() throws UnsupportedEncodingException{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = PublicManagerUtil.SUCCESS,str = "",rTime="";
		try{
	...
	public Object createTwoDimensionCode(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = PublicManagerUtil.SUCCESS, encoderImgId = this.get32UUID()+".png"; //encoderImgId此处二维码的图片名
	...
	public Object readTwoDimensionCode(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = PublicManagerUtil.SUCCESS,readContent="";
	...
	public Object getDistance(){
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		String errInfo = PublicManagerUtil.SUCCESS,distance="";
		try {
