package com.lk.controller.system.head;
...
import com.lk.service.system.fhsms.FhsmsManager;
...
import com.lk.util.SmsUtil;
import com.lk.util.Tools;
import com.lk.util.Watermark;
import com.lk.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	...
	public Object getList() {
		...
		try {
			...
			PageData pds = userService.findByUsername(pd);
			pdList.add(pds);
			map.put("list", pdList);
		...
		if("yes".endsWith(isAll)){
			try {
				...
				try {
					...
					msg = PublicManagerUtil.OK;
				} catch (Exception e) {
					msg = PublicManagerUtil.ERROR;
				}
			} catch (Exception e) {
				msg = PublicManagerUtil.ERROR;
			}
	...
	public Object sendEmail(){
		...
		pd = this.getPageData();
		Map<String,Object> map = new HashMap<String,Object>();
		String msg = PublicManagerUtil.OK;		//发送状态
		int count = 0;			//统计发送成功条数
		int zcount = 0;			//理论条数
	...
	public ModelAndView saveSys() throws Exception{
		...
		mv.addObject("msg",PublicManagerUtil.OK);
