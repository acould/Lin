...
public class SimpleMailSender extends BaseController {
	//MAIL(邮箱属性)
	public static final String MAILSERVERHOST= "smtp.qq.com";
	public static final String MAILSERVERPOR= "25";
	public static final String USERNAME= "itfather@1b23.com";
	public static final String PASSWORD= "tttt";
	public static final String FROMADDRESS= "itfather@1b23.com";
	public static final String TOADDRESS= "313596790@qq.com";
	public static final String SUBJECT= "设置邮箱标题";
	public static final String CONTENT= "设置邮箱内容";
	...
	public boolean sendMail(String title, String content, String type, String tomail) throws Exception {
		...
		mailInfo.setMailServerPort(MAILSERVERPOR);
	...
	public static void main(String[] args){
		try {
			sendEmail("smtp.qq.com", "25", "itfather@1b23.com", "123",
					"905207503@qq.com", "1", "2", "1");
		} catch (Exception e) {
			e.printStackTrace();
		}
