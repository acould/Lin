...
public class Jurisdiction {
    ...
    public static String getUsername() {
        return getSessionUser().getUser().getUSERNAME();
    }
    ...
    public static SessionUser getSessionUser() {
        ...
        SessionUser sessionUser = (SessionUser) subject.getSession().getAttribute(Const.SESSION_USER);
        return sessionUser;
    }
     ...
     * @return
     */
    public static void setSessionUser(User user, WechatUser wechatUser, BundUser bundUser) {
        ...
        if(wechatUser != null)
            sessionUser.setWechatUser(wechatUser);
