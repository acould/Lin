package com.lk.service.weixin.imgmsg;
...
public class ImgmsgService {
	...
	@SuppressWarnings("unchecked")
	public List<PageData> listByKw(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("ImgmsgMapper.listByKw", pd);
	}
}
