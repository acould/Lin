            ...
            <div class="layui-card-body" style="padding: 20px 20px">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label" style="font-size:.6rem">是否有自助机</label>
                            <div class="layui-input-block">
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm layui-btn-success " lay-event="edit" id="edit" >编辑</a>
<%--    {{#  if(d.autosell_username){ }}--%>
<%--    <a class="layui-btn layui-btn-sm layui-btn-danger" lay-event="edit2" id="edit2">商品设置</a>--%>
    {{#  if(d.autosell_username){ }}
    <a class="layui-btn layui-btn-sm layui-btn-danger" lay-event="edit2" id="edit2">商品设置</a>
    {{#  } }}
