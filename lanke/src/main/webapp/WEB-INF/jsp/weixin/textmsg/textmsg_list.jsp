							...
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;"> 
								 	<select class="chosen-select form-control" name="STATE" id="STATE" data-placeholder="请选择状态" style="vertical-align:top;width: 120px;">
										...
										<option value="1" <c:if test="${pd.STATE==1}">selected</c:if>>有效</option>
										<option value="2" <c:if test="${pd.STATE==2}">selected</c:if>>无效</option>
								  	</select>
								</td>
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td style="width: 60px;" class="center">
												<c:if test="${var.STATE == '2' }"><span class="label label-important arrowed-in">无效</span></c:if>
												<c:if test="${var.STATE == '1' }"><span class="label label-success arrowed">有效</span></c:if>
											</td>
