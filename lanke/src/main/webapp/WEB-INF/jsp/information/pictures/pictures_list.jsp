...
<![endif]-->
<!--查看图片插件 -->
<link rel="stylesheet" media="screen" type="text/css" href="<%=basePath%>plugins/zoomimage/css/zoomimage.css" />
<link rel="stylesheet" media="screen" type="text/css" href="<%=basePath%>plugins/zoomimage/css/custom.css" />
<script type="text/javascript" src="<%=basePath%>plugins/zoomimage/js/jquery.js"></script>
<script type="text/javascript" src="<%=basePath%>plugins/zoomimage/js/eye.js"></script>
<script type="text/javascript" src="<%=basePath%>plugins/zoomimage/js/utils.js"></script>
<script type="text/javascript" src="<%=basePath%>plugins/zoomimage/js/zoomimage.js"></script>
<script type="text/javascript" src="<%=basePath%>plugins/zoomimage/js/layout.js"></script>
<!--查看图片插件 -->
</head>
<body class="no-skin">
