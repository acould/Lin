...
<link rel="stylesheet" type="text/css" href="<%=basePath%>plugins/webuploader/style.css" />
</head>
<body class="no-skin">
	...
	<!-- webuploader上传插件js -->
   	...
   	<script type="text/javascript" src="<%=basePath%>plugins/webuploader/upload.js"></script>
