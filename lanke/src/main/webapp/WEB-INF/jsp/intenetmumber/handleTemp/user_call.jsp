...
<form id="Form">
    <div class="weui-cells weui-cells_form">
        ...
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">呼叫时间</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" type="text"  value="${pd.keyword1}" readonly>
            </div>
        </div>
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">呼叫类型</label></div>
            <div class="weui-cell__bd">
                <input class="weui-input" type="text"  value="需要帮助" readonly>
            </div>
        </div>
        <div class="weui-cell">
            <div class="weui-cell__hd"><label class="weui-label">呼叫人员</label></div>
            <div class="weui-cell__bd">
    ...
    <c:if test="${state == '2'}">
        <div class="weic-bor" style="margin: 1.4rem 0">
            <div class="weic-dent-btn weic-btn-gradientBlue" onclick="save()">确定收到</div>
        </div>
    </c:if>
</form>
