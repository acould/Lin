								...
								<table class="tablemargin">
									<tr>
										<td>
											<div class="nav-search">
												<span class="input-icon"> <input type="text"
													placeholder="请输入姓名或手机号" class="nav-search-input"
										...
										<td style="vertical-align: middle; padding-left: 15px;">
											...
											<select class="chosen-select form-control" name="STORE_ID"
											id="STORE_ID" data-placeholder="请选择"
										...
										<td style="vertical-align: middle; padding-left: 15px;">
											<lable class="lablepd">角色:</lable> <select
										...
										<c:if test="${QX.cha == 1 }">
											<td style="vertical-align: middle; padding-left: 15px"><a
												...
												title="检索"> <i class="layui-icon" style="padding-right: 4px; font-size: 14px;">&#xe615;</i>搜索
											</a></td>
										</c:if>
									</tr>
								</table>
												...
												<c:if test="${QX.cha == 1 }">
													<c:forEach items="${userList}" var="var" varStatus="vs">
														<tr>
															...
															<td class='center' style="vertical-align: middle;">${var.ROLE_NAME}</td>
															...
															<td class="center" style="vertical-align: middle;">
																...
																<div class="hidden-sm hidden-xs btn-group">
																	<c:if test="${QX.edit == 1 }">
																		<a class="btn btn-sm btn-success" title="编辑" onclick="edit('${var.USER_ID}');">
																		  <i class="layui-icon" style="padding-right: 4px">&#xe642;</i>编辑
																		</a>
																	</c:if>
																	<c:if test="${QX.del == 1 }">
																		<a class="btn btn-sm btn-danger" onclick="del('${var.USER_ID}');">
																...
																<div class="hidden-md hidden-lg">
																	<div class="inline pos-rel lk-ul-hoverShow">
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																			<c:if test="${QX.edit == 1 }">
																				<li>
																					<a style="cursor: pointer;" onclick="edit('${var.USER_ID}');" class="tooltip-success" data-rel="tooltip" title="编辑">
	...
	<script type="text/javascript">
       ...
       function add(){
            ...
            btn1: function(index, layero){
                ...
                fixed: false, //不固定
  				maxmin: true,
                content:[ '<%=basePath%>account/goAdd.do '],
            });
		}
		...
		function del(Id){
			layer.confirm('确定要删除吗?', {
                	...
                	$.ajax({
		    				...
		    				data: {USER_ID:Id,tm:new Date().getTime()},
							dataType:'json',
							cache: false,
		...
		function edit(ID){
			layer.open({
                	...
                	fixed: false, //不固定
  					maxmin: true,
                	content:[ '<%=basePath%>account/goEdit.do?USER_ID='+ID ],
            	});
			}
