...
<body>
	...
	<tr class="center" style="cursor:pointer;">
		<td><label onclick="seticon('menu-icon fa fa-check-circle');"><i class="menu-icon fa fa-check-circle"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-address-book-o');"><i class="menu-icon fa fa-address-book-o"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-pencil-square');"><i class="menu-icon fa fa-pencil-square"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-plus-square');"><i class="menu-icon fa fa-plus-square"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-paper-plane');"><i class="menu-icon fa fa-paper-plane"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-tags');"><i class="menu-icon fa fa-tags"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-qq');"><i class="menu-icon fa fa-qq"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-weixin');"><i class="menu-icon fa fa-weixin"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
		<td><label onclick="seticon('menu-icon fa fa-weibo');"><i class="menu-icon fa fa-weibo"></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
	</tr>
				<!-- <tr>
