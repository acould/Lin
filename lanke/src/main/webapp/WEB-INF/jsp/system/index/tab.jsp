...
<html lang="en">
	...
	<link href="<%=basePath%>plugins/tab/css/import_basic.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" charset="utf-8" src="<%=basePath%>plugins/tab/js/tab.js"></script>
	</head>
	<style>
		/*.benma_ui_tab .tab_hr {display: none}*/
	</style>
<body>
<div id="tab_menu"></div>
<div style="width:100%;">
