		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="intenet/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="INTENET_ID" id="INTENET_ID" value="${pd.INTENET_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">网吧名称:</td>
								<td><input type="text" name="INTENET_NAME" id="INTENET_NAME" value="${pd.INTENET_NAME}" maxlength="80" placeholder="这里输入网吧名称" title="网吧名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">微信公众号id:</td>
								<td><input type="text" name="WECHAT_ID" id="WECHAT_ID" value="${pd.WECHAT_ID}" maxlength="100" placeholder="这里输入微信公众号id" title="微信公众号id" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">微信key:</td>
								<td><input type="text" name="WECHAT_KET" id="WECHAT_KET" value="${pd.WECHAT_KET}" maxlength="100" placeholder="这里输入微信key" title="微信key" style="width:98%;"/></td>
							</tr>
							<%-- <tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">状态:</td>
								<td><input type="text" name="STATE" id="STATE" value="${pd.STATE}" maxlength="2" placeholder="这里输入状态" title="状态" style="width:98%;"/></td>
							</tr> --%>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">支付宝账户:</td>
								<td><input type="text" name="TAO_BAO" id="TAO_BAO" value="${pd.TAO_BAO}" maxlength="100" placeholder="这里输入支付宝账户" title="支付宝账户" style="width:98%;"/></td>
							</tr>
							<tr>
