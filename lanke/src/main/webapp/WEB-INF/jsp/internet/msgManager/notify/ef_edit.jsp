...
<form class="layui-form" action="" style="padding:20px 30px" lay-filter="form" id="form">
    ...
    <input type="hidden" value="equipment_failure" id="temp_type" name="temp_type">
    ...
    <div class="layui-form-item" id="store_box">
        <label class="layui-form-label">故障门店：</label>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="fault_time"  id="fault_time" lay-verify="required" placeholder="请选择故障时间"
...
<script>
    layui.use(["form","layer","laydate"],function (){
        ...
        function initialize(){
            ...
            $.post('<%=basePath%>msgManager/loadTempMsg.do', field, function (res){
                ...
                form.val("form",{
                    ...
                    ,"fault_time":keyword_data.keyword2
        ...
        form.on('submit(submit)', function(data){
            ...
            keyword_data.keyword2 = $("#fault_time").val();
