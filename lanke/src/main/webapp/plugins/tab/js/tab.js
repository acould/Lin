        ...
        if (a.current == null || a.current != this) {
            $(p).mouseover(function () {
                ...
                if (a.current != null) {
                    ...
                    $(".tab_item3"+b).parent().parent().parent().css({"border":"1px solid #e1e1e1","border-bottom":"none","border-right":"none"})
                ...
                $(".tab_item3_selected"+b).parent().parent().parent().css("border","none")
                a.current = this;
