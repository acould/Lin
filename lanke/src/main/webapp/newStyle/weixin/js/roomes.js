...
// $(".animatedh").click(function(){
//     $(".modal").addClass("animated  zoomInRight");
//     $(".modal").show();
//     setTimeout(function(){$(".modal").removeClass("animated  zoomInRight");},500);
//     $(".modal").stopPropagation();
// })
// $(".modal-textBor").click(function(){
//     $(".modal").addClass("animated  zoomOutLeft")
//     setTimeout(function(){$(".modal").removeClass("animated  zoomOutLeft");},500);
// })
