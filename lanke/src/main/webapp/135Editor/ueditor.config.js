...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ['cleardoc',"paragraph","fontfamily","fontsize","inserttable",'background','simpleupload',"insertimage",'insertvideo',"horizontal","|","undo","redo","|","more"],//,'music'
